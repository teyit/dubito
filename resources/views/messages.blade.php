@extends('layout.app')
    ...
    <div class="be-wrapper be-aside be-fixed-sidebar">
        <nav class="navbar navbar-default navbar-fixed-top be-top-header">
            <div class="container-fluid">
                ...
                <div class="be-right-navbar">
                    ...
                    <div class="page-title"><span>Email Inbox</span></div>
        ...
        <div class="be-left-sidebar">
            <div class="left-sidebar-wrapper"><a href="#" class="left-sidebar-toggle">Email Inbox</a>
                        ...
                        <div class="aside-nav collapse thread-list">
                            <ul class="nav">
                                @for($i=0;$i<30;$i++)
                                    ...
                                    <li @if($i == 4) class="active" @endif>
                                        <a href="#">
                                            @if($i == 4)<span class="thread-count label label-primary">8</span>@endif
                                            <div style="width:32px;height:32px;float:left;border-radius:50%;overflow:hidden;background-image:url('http://serafettin.net/images/serafettin.jpg');background-size:cover;"></div>
                                            <span class="thread-name">John Coltrane </span>
                                        </a>
                                    </li>
                                @endfor
