                        ...
                        <div class="row">
                            <div class="col-md-12">
																	<div class="">
																		<div class="row panel-heading panel-heading-divider">
																			<div class="col-md-8" style="padding:0">
																				{{$case->title}}@if($case->google_document_id) <a target="_blank" class="btn btn-primary new-google-document" href="https://docs.google.com/document/d/{{$case->google_document_id}}/edit">Go to Analysis</a>@endif
																			...
																			<span class="">
																				...
																				</div></span><span class=""><button data-status="{{$case->is_archived}}" class="btn btn-{{$case->is_archived == 'archived' ? 'danger' : "warning"}} case-is-archived-btn">{{$case->is_archived == 'archived' ? 'Remove Archive' : "Send to Archive"}}</button></span>
																		</div>
																		</div>
																	</div>
															...
															<div class="row" style="padding:0 0 0 20px; margin-bottom:5px;">
																<div class="col-md-6">
																	<span class="mdi mdi-account"></span><strong style="padding-left:10px;">Assign User:  </strong><a id="assign-user-case" data-title="Assign user to case" data-value="{{$case->user->id}}"  data-type="select" href="#" class="editable editable-click">{{$case->user->name or ''}}</a>
                            ...
                            <li class="latest">
                                ...
                                <div class="gallery-container evidence-gallery-container">
                                    @foreach($evidence->files as $file)
                                        <div class="item">
                                            <div class="photo">
                                                <div class="img"><img class="img-respınsive" src="{{Storage::disk('s3')->url($file->file_url)}}" alt="Gallery Image">
                                                    <div class="over">
                                                        <div class="info-wrapper">
                                                            <div class="info">
