...
@section("content")
        ...
        <div class="page-head">
            <h2 class="page-head-title">Topics</h2>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Topic<span class="panel-subtitle">Topic</span></div>
                        <div class="panel-body">
                            <form method="post" action="{{route("topics.store")}}">
                                {{ csrf_field() }}
                                <div class="form-group xs-pt-10">
                                    <label>Title</label>
                                    <input type="text" name="title" value="{{isset($topic) ? $topic->title : ""}}" required placeholder="Enter category title" class="form-control">
                                </div>
                                <div class="form-group xs-pt-10">
