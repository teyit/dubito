        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-flat">
                    <div class="panel-heading">Hasan Uzun</div>
                    <div class="panel-body">
                        ...
                        <button class="btn btn-warning btn-xs">Incelemeye Al</button>
                        <button class="btn btn-primary btn-xs">Arsivle</button>
                        <button class="btn btn-success btn-xs">Ozel Cevap</button>
                        </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-border">
                    <div class="panel-heading panel-heading-divider">Panel with tools
                        <div class="tools"><span class="icon mdi mdi-refresh-sync"></span><span class="icon mdi mdi-more-vert"></span></div><span class="panel-subtitle">Panel subtitle description</span>
                    </div>
                    <div class="panel-body">
                        <p>Quisque gravida aliquam diam at cursus, quisque laoreet ac lectus a rhoncusac tempus odio.</p>
                        <p>Aliquam posuere volutpat turpis, ut euimod diam pellentesque at. Sed sit amet nulla a dui dignisim euismod. Morbi luctus elementum dictum. Donec convallis mattis elit id varius. Quisque facilisis sapien quis mauris,, erat condimentum.</p>
